...
products = [
  ...
  },
  {
    ...
    "category": "mercearia",
    "unit": "1kg",
    "image": "https://images.unsplash.com/photo-1582176647440-3b137b3106e4?w=400&auto=format&fit=crop&q=80",
    "encarteId": 30,
    "offerMarketId": "bh",
    "offerPrice": 45.98,
    "validity": "Válido até 15/09/2026",
...
const ENCARTES = {json.dumps(encartes, indent=2, ensure_ascii=False)};
...
output_path = os.path.join(base_dir, "js", "data.js")
